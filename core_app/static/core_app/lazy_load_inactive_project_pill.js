(function($) {
    // If clicked on the Load Glyph More Projects button at the bottom of an inactive project pill tab
    $('#lazyLoadLinkProjects').on('click', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                // append html to the project_list div
                $('#project_list').append(data.project_html);
            },
